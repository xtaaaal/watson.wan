    ...
    class Item {
        constructor(el) {
            ...
            this.renderedStyles = {
                ...
                // - translating/rotating the title
                // - rotating the item
                ...
                titleTranslationY: {
                    ...
                    current: 0, 
                    ease: 0.08,
                    fromValue: Number(MathUtils.getRandomFloat(50,1000)),
                    setValue: () => {
                ...
                titleRotation: {
                    ...
                    current: 0, 
                    ease: 0.1,
                    fromValue: Number(MathUtils.getRandomFloat(-75,75)),
                    setValue: () => {    
                        const fromValue = this.renderedStyles.titleRotation.fromValue;
                        const toValue = fromValue+15;
                        const val = MathUtils.map(this.props.top - docScroll, winsize.height, -1 * this.props.height, fromValue, toValue);
        ...
        layout() {
            // translate/rotate the title
            this.DOM.title.style.transform = `rotate3d(0,0,1,${this.renderedStyles.titleRotation.previous}deg) translate3d(0,${this.renderedStyles.titleTranslationY.previous}px,0)`;
            // rotate the image wrapper
            this.DOM.imageWrapper.style.transform = `rotate3d(0,0,1,${this.renderedStyles.itemRotation.previous}deg)`;
        }
    }
